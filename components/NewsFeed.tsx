...
const NewsFeed: React.FC<NewsFeedProps> = ({ activeCategory, searchQuery, onSelectArticle, bookmarks, toggleBookmark }) => {
  ...
  const loadNews = useCallback(async () => {
    ...
    try {
      const response = await fetchNews(activeCategory, searchQuery);
