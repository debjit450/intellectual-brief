 ...
 * This component generates and serves sitemap XML dynamically
...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  <url>
    <loc>https://theintellectualbrief.online/</loc>
    ...
    return (
      <div className="min-h-screen bg-paper dark:bg-paper-dark flex items-center justify-center">
        <div className="text-center">
          <p className="text-neutral-600 dark:text-neutral-400">Generating sitemap...</p>
        </div>
      </div>
    );
  }
